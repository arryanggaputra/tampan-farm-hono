    ...
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Pengeluaran non-hewan (kandang, pakan, obat, upah)</p>
        </div>
      ...
      {data && data.length > 0 && (
        <div className="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm">
          ...
          <span className="font-bold text-amber-800">{formatRupiah(totalBiaya)}</span>
        </div>
      )}
          ...
          {data?.map((expense) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-sm font-bold text-gray-900 shrink-0">{formatRupiah(expense.cost)}</p>
